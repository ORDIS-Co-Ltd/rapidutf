...
private:
  static auto utf8_to_utf16_common(const unsigned char *bytes, std::size_t length, std::u16string &utf16) -> void;
  static auto utf16_to_utf8_common(const char16_t *chars, std::size_t length, std::string &utf8) -> void;
  static auto utf16_to_utf32_common(const char16_t *chars, std::size_t length, std::u32string &utf32) -> void;
  static auto utf32_to_utf16_common(const char32_t *chars, std::size_t length, std::u16string &utf16) -> void;
  ...
  static auto utf8_to_utf16_sse42(const std::string &utf8) -> std::u16string;
  static auto utf16_to_utf8_sse42(const std::u16string &utf16) -> std::string;
  static auto utf16_to_utf32_sse42(const std::u16string &utf16) -> std::u32string;
  static auto utf32_to_utf16_sse42(const std::u32string &utf32) -> std::u16string;
  static auto utf8_to_utf32_sse42(const std::string &utf8) -> std::u32string;
  static auto utf32_to_utf8_sse42(const std::u32string &utf32) -> std::string;
